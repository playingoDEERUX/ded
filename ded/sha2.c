...
static inline void WriteLE32(unsigned char* p, uint32_t v) {
    p[0] = (unsigned char)(v);
...
void inline Round(__m256i a, __m256i b, __m256i c, __m256i& d, __m256i e, __m256i f, __m256i g, __m256i& h, __m256i k)
{
